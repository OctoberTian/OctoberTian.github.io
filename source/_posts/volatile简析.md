...
categories: Java
abbrlink: 9c9206b1
date: 2019-08-23 14:27:05
---

## 前言

volatile简析，这个关键字虽然在多线程中起到了重要的作用而且使用便捷，但是真正了解他还是很难的
...
如以上代码，是一个比较典型的使用**双重锁校验的形式实现单例**的，其中使用`volatile`关键字修饰可能被多个线程同时访问到的singleton。
